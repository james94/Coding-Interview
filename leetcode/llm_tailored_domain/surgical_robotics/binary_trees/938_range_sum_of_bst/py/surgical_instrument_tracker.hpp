...
public:
    ...
    std::string displayInstrumentMovements(int min_distance, int max_distance) {
        int totalMovements = sumInRange(min_distance, max_distance);

        std::stringstream ss;
        ss << "Surgical Instrument Tracking System:\n";
        ss << "------------------------------------\n";
        ss << "Calculating total movements of instruments within range:\n";
        ss << "Minimum distance: " << min_distance << " mm\n";
        ss << "Maximum distance: " << max_distance << " mm\n";
        ss << "Total movements: " << totalMovements << " units\n";
        ss << "------------------------------------\n";
        return ss.str();
    }
